...
from gbpservice.nfp.core_ahmed import cfg as nfp_cfg
from gbpservice.nfp.core_ahmed import common as nfp_common
from gbpservice.nfp.core_ahmed import event as nfp_event
from gbpservice.nfp.core_ahmed import launcher as nfp_launcher
from gbpservice.nfp.core_ahmed import log as nfp_logging
from gbpservice.nfp.core_ahmed import manager as nfp_manager
from gbpservice.nfp.core_ahmed import poll as nfp_poll
from gbpservice.nfp.core_ahmed import rpc as nfp_rpc

from gbpservice.nfp.core_ahmed import worker as nfp_worker
...
class NfpController(nfp_launcher.NfpLauncher, NfpService):
    ...
    def _verify_graph(self, graph):
        ...
        for parent, childs in graph.iteritems():
            ...
            assert puuid not in graph_sig.keys(), "Event - %s is already root of subtree - %s" % (
